...
public class QuestionsSite extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		switch (form) {
			...
			case "savequestion":
				QuestionsEntity question = new QuestionsEntity(Integer.parseInt(request.getParameter("id")),
						request.getParameter("question"), request.getParameter("option_one"),
						request.getParameter("option_two"), request.getParameter("option_three"),
						request.getParameter("option_four"), Integer.parseInt(request.getParameter("correct_option")));
				new QuestionsModel().save(question);
				listquestions(request, response);
				break;

			case "updatequestion":
				QuestionsEntity updatequestion = new QuestionsEntity(Integer.parseInt(request.getParameter("id")),
						request.getParameter("question"), request.getParameter("option_one"),
						request.getParameter("option_two"), request.getParameter("option_three"),
						request.getParameter("option_four"), Integer.parseInt(request.getParameter("correct_option")));
	...
	protected void listquestions(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
